...
const Cryptocurrencies = ({ cryptocurrencies, isLoading }) => {
  ...
  const { data7Days, error, is7Dloading } = useGetCryptosChangeQuery({
    count,
    timePeriod,
  });
              ...
              <table className="divide-y divide-gray-300 bg-gray-100">
                <thead className="">
                  <tr>
                    ...
                    <th className=" py-2 text-sm text-gray-500 text-left">
                      <SelectList />
                    </th>
                  ...
                  {cryptocurrencies?.map(
                    ({
                      ...
                      >
                        ...
                        <td
                          className={`px-6 py-4 text-sm flex justify-center items-center  ${

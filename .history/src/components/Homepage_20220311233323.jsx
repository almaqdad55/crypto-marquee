    ...
    <div className="w-full m-30 ">
      <div className="flex flex-col items-center justify-center mt-[170px] xl:mt-[220px]   xl:flex-row">
        <div className="flex flex-col justify-center items-center ">
          <h1 className="text-[#093D6E] font-bold text-2xl  mb-10 text-center">
        ...
        <div className="flex flex-col items-center ">
          <div className="flex flex-col items-center bg-blue-50  p-8 rounded-lg shadow-sm ">
            ...
            <div className="flex flex-col space-y-5 ">
              ...
              <div className="flex items-center  justify-between border-b  border-gray-300 pb-2 space-x-6 my-5">
                <div className="flex space-x-6">
                  <div className="bg-[#0071bd] text-white rounded-full p-[5px] ">
                    <BsCoin />
                  </div>
